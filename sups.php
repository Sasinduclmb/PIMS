...
<head>
    ...
    <title>Information of Suplliers</title>
    <style>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 mb-5">
                    <h1 class="text-center mt-5 text-white">Details of Suplliers</h1>
                </div>
                ...
                ">
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $rows['company_r_no']; ?></td>
